...
import static com.mufeng.common.constant.UserConstant.ADMIN_ROLE;
import static com.mufeng.common.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public boolean changeUserPwd(String userPassword, long userId) {
        String encryptPassword = DigestUtils.md5DigestAsHex((SALT + userPassword).getBytes());
        return userMapper.changeUserPwd(userId,encryptPassword);
    }

    @Override
    public KeyVO getKey(long userId) {
